    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                (
                    "id",
                    models.UUIDField(
                        default=activitylog.models.default_uuid,
                        editable=False,
                        primary_key=True,
                        serialize=False,
                        unique=True,
                ...
                (
                    "url",
                    models.CharField(
                        blank=True, db_index=True, max_length=254, null=True, verbose_name="URL"
                    ),
                ),
                (
                    "method",
                    models.CharField(
                        db_index=True, max_length=20, null=True, verbose_name="Method"
                    ),
                ),
                ...
                (
                    "platform",
                    models.TextField(blank=True, null=True, verbose_name="Platform fields"),
                ),
                (
                    "operating_system",
                    models.TextField(blank=True, null=True, verbose_name="Operating System fields"),
                ),
                (
                    "latitude",
                    models.CharField(
                        blank=True, max_length=500, null=True, verbose_name="latitude fields"
                    ),
                ),
                (
                    "longitude",
                    models.CharField(
                        blank=True, max_length=500, null=True, verbose_name="longitude fields"
                    ),
                ),
                (
                    "city",
                    models.CharField(
                        blank=True, max_length=500, null=True, verbose_name="city fields"
                    ),
                ),
                (
                    "country",
                    models.CharField(
                        blank=True, max_length=500, null=True, verbose_name="country fields"
                    ),
                ),
                (
                    "remote_ip",
                    models.CharField(
                        db_index=True, max_length=50, null=True, verbose_name="Remote IP"
                    ),
                ),
                (
                    "datetime",
            ...
            fields=[
                ...
                (
                    ...
                    models.SmallIntegerField(
                        choices=[(0, "Login"), (1, "Logout"), (2, "Failed login")],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "query_string",
                    models.TextField(blank=True, null=True, verbose_name="Query string"),
                ),
                ("browser", models.TextField(blank=True, null=True, verbose_name="Browser fields")),
                (
                    "platform",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "object_repr",
                    models.TextField(blank=True, null=True, verbose_name="Object representation"),
                ),
                (
                    "object_json_repr",
                    models.TextField(
                        blank=True, null=True, verbose_name="Object JSON representation"
                    ),
                ),
                ("browser", models.TextField(blank=True, null=True, verbose_name="Browser fields")),
                (
                ...
                (
                    "changed_fields",
                    models.TextField(blank=True, null=True, verbose_name="Changed fields"),
                ),
                (
                    "user_pk_as_string",
                    models.CharField(
                        ...
                        max_length=255,
                        null=True,
                        verbose_name="User PK as string",
                    ),
                ),
                ("datetime", models.DateTimeField(auto_now_add=True, verbose_name="Date time")),
                (
